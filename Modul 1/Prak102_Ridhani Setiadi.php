...
switch ($nim % 10) {
    ...
    case 1:
        ...
        echo number_format($tabung, 3). " m^3 ";
        break;
    case 2:
    case 3:
        $kerucut = 1/3 * 3.14 * $Jarijari * $Jarijari * $tinggi;
        echo number_format($kerucut, 3). " m^3 ";
        break;
    case 4:
    case 5:
        $bola = 4/3 * 3.14 * $Jarijari * $Jarijari * $Jarijari;
        echo number_format($bola, 3). " m^3 ";
        break;
    case 6:
    case 7:
        $prismaAlasSegitiga = 1/2 * $alasPrisma * $tinggiPrisma;
        echo number_format($prismaAlasSegitiga, 3). " m^3 ";
        break;
    case 8:
    case 9:
        $limasAlasPersegiPanjang = 1/3 * $panjang * $lebar * $tinggiLimas;
        echo number_format($limasAlasPersegiPanjang, 3). " m^3 ";
        break;
    default:
