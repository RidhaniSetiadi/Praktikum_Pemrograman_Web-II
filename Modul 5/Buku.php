...
<head>
    ...
    <style>
        html {
            background-image: url('poto_2.jpg');
        ...
        <div class="row justify-content-center">
            ...
            <table class="table table-striped table-hover text-center rounded shadow">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="Form_Buku.php?id_buku=<?php echo $data['id_buku']; ?>"><button
            ...
            <div class="col-md-8 text-center mt-4">
                <div class="btn-container">
                    ...
                    <a href="Form_Buku.php" class="btn btn-primary btn-sm">Tambah Data Baru</a>
                </div>
            </div>
        </div>
    </div>
